...
with open("tweet3.json","w") as f:
    # api.search
    count=0
    for tweet in tweepy.Cursor(api.search, q=search_term, geocode = "-37.999250,144.5800,40km", result_type="recent", include_entities=False).items(1000000):
        # print(tweet._json)
